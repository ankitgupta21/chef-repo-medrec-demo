...
usage()
{
	...
	echo "ADMIN_URL defaults to t3://test-medrec:7011 if not set as an environment variable or the second command-line parameter."
	...
	echo "for example:"
	echo "$1 managedserver1 t3://test-medrec:7011 weblogic weblogic"
}
